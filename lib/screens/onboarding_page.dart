...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  List<ItemPage> item = [
    ItemPage(
        title: 'Welcome to Coin Sense: Your Personal Finance Companion',
        image: 'assets/images/finance1.png',
        subtitle:
            'Unlock the power of smart budgeting and take control of your finances effortlessly with Coin Sense, your all-in-one financial management solution.'),
    ItemPage(
      title: 'Getting Started: Set Up Your Budget in Minutes',
      subtitle:
          'Easily create your personalized budget by inputting your income, expenses, and savings goals, and let Coin Sense handle the rest.',
